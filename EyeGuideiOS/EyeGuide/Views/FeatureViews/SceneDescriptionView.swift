...
struct SceneDescriptionView: View {
        ...
        ZStack {
            ...
            if viewModel.isAnalyzing {
                ...
                ProgressView()
                    .tint(.white)
                    .scaleEffect(1.3)
                    .accessibilityLabel("Analyzing scene")
            }
        }
    ...
    private var statusPill: some View {
        ...
        .accessibilityLabel(viewModel.isAutoAnalyzing ? "Live analysis active" : "Analysis paused")
    }
    ...
    private var resultCard: some View {
        ...
        .accessibilityLabel("Scene description: \(viewModel.aiResult)")
    }
